...
export const commerceLayouts: ViewLayout[] = [
  ...
  },
  {
    ...
    elements: [
      { elementId: "checkout-page", x: 60, y: 220 },
      { elementId: "checkout-domain", x: 300, y: 220 },
      { elementId: "basket-adapter", x: 560, y: 40 },
      { elementId: "pricing-module", x: 560, y: 160 },
      { elementId: "payment-module", x: 560, y: 280 },
      { elementId: "order-module", x: 560, y: 400 },
      { elementId: "checkout-api-client", x: 560, y: 520 },
      { elementId: "product-store", x: 840, y: 40 },
      { elementId: "product-service", x: 840, y: 160 },
      { elementId: "checkout-service", x: 840, y: 520 },
    ],
  },
];
